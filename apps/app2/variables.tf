...
variable "dev_project_id" {
  description = "GCP project ID for the app2 dev environment"
  type        = string
}

variable "test_project_id" {
  description = "GCP project ID for the app2 test environment"
  type        = string
}

variable "qa_project_id" {
  description = "GCP project ID for the app2 qa environment"
  type        = string
}

variable "prod_project_id" {
  description = "GCP project ID for the app2 prod environment"
  type        = string
}
