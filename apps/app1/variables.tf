...
variable "dev_project_id" {
  description = "GCP project ID for the app1 dev environment"
  type        = string
}

variable "test_project_id" {
  description = "GCP project ID for the app1 test environment"
  type        = string
}

variable "qa_project_id" {
  description = "GCP project ID for the app1 qa environment"
  type        = string
}

variable "prod_project_id" {
  description = "GCP project ID for the app1 prod environment"
  type        = string
}
